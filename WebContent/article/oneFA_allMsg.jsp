                ...
                <div class="col-lg-8">
                    <div class="blog-details-inner">
                        ...
                        <span class="cat">
                            ...
                            <input type="hidden" value="時間">
                            <a href="#" class="tag me-0">
                                <i class="ri-price-tag-3-fill"></i>Burgar
                            </a>
                        </span>                       
                        <h3><%=faVO.getArticleTitle()%></h3><input type="hidden" value="文章標題">

                        <p> 
                        <%=faVO.getArticleContent()%>
                        </p>
                        
<%--                         <jsp:useBean id="pbSvc" scope="page" class="com.picturebase.model.PictureBaseService" /> --%>
...
<%--                                <c:forEach var="pbVO" items="${pbSvc.PicturesOfAr}"> --%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mt-3 mt-sm-0 align-items-center">
                                <ul class="social-area text-sm-end mt-md-0 mt-2">
                                    <li><a href="https://zh-tw.facebook.com/"><i class="fab fa-facebook-f"></i></a></li> 
...
<!--                                  </div>   -->
                            ...
                            <div class="col-12">
                                <div class="single-textarea-wrap">
                                    ...
                                    <input typa="hidden" value="1">
                                    <input type="hidden" value="訊息">
                                </div>
                            </div>
                        </div>
