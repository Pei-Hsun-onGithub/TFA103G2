...
CREATE TABLE Card (
 ...
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(1, '陳國恩', 4716329842362253, '2023-12-31', 466, '新竹市北區經國路一段238號', 234, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(2, '林思倫', 2058942978991061, '2024-05-31', 689, '台南市安南區安和路一段186巷15號', 167, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(3, '王子純', 9318776636761858, '2023-04-31', 233, '台中市太平區宜欣路267號', 346, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(4, '張苑迪', 8765432187654321, '2023-01-31', 006, '新北市三峽區大勇路238號', 324, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(5, '昌逸禎', 0538755043873639, '2025-03-31', 643, '高雄市鳳山區平等路38號', 632, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(6, '王威廷', 5332056483252861, '2023-11-31', 360, '苗栗縣頭份市信中路105巷8號7樓', 345, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(7, '梁瑋蓁', 2400596074546732, '2022-10-31', 711, '新竹縣湖口鄉仁樂路190號', 465, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(8, '徐怡婷', 5950976460340512, '2021-12-31', 885, '台北市內湖區新湖三路244號', 269, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(9, '陳宗翰', 1234567812345678, '2024-02-31', 152, '雲林縣台西鄉崙豐路46號', 234, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(10, '胡威廷', 9542710573627430, '2025-05-31', 075, '台中市北屯區軍功路二段177巷11號', 123, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(11, '蔡吉友', 6956674759132833, '2024-08-31', 171, '新竹縣關西鎮中山東路39號', 543, 1);
 INSERT INTO Card (userid, cardholder, cardnumber, deadline, cvv, billaddress, zipcode, sta)
 	VALUES(12, '陳冠軒', 3597905196233614, '2023-12-31', 044, '台北市文山區萬美街一段85巷3號7樓', 456, 1);
