...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/vendors/error/style.css">
<!-- Stylesheet -->
<link rel="stylesheet"
...
<body>
	...
	<div id="wrapper">
		...
		<div class="grid">
			<span class="server"></span> <span class="server"></span> <span
				class="server"></span> <span class="server"></span> <span
				class="server"></span>
		</div>

		<div class="content">
			<h4 class="describe">抱歉!系統忙線中...</h4>
		</div>

		<div class="my-btn-wrap">

			<a type="button" class="btn btn-info my-btn-info"
				href="<%=request.getContextPath()%>/home.jsp">回首頁</a>
	...
	<script src="<%=request.getContextPath()%>/assets/js/main.js"></script>
	<!-- partial -->
	<script src="<%=request.getContextPath()%>/vendors/error/script.js"></script>
